...
import com.example.pr.EditActivity;
...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_list_layout, parent, false); //Для отрисовки наших значений на экране
